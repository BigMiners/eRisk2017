...
Description : smiley mapping (from smiley to word / signification), in alphabetical order, in the purpose of a forum's sentimental analysis. 
...
In the second version, every smiley with an occurence of 1 was removed, if it could'nt be associated with another description.